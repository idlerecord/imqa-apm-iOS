...
///
/// A `CaptureService` is an object that can be passed to the imqa during setup
...
open class CaptureService: NSObject {
    ...
    /// `IMQAConsoleLogger` instance used to generate internal logs.
    ...
    public func install(otel: IMQAOpenTelemetry?, logger: InternalLogger? = nil) {
