...
class CrashlyticsWrapper {
    ...
    let queue: DispatchQueue = DispatchQueue(label: "com.imqa.crashlytics_wrapper")
    ...
    private func updateSessionId() {
        ...
        setCustomValue(key: "imqa-sid", value: currentSessionId)
    }
    ...
    private func updateSDKVersion() {
        ...
        setCustomValue(key: "imqa-sdk", value: sdkVersion)
    }
}
