...
public struct CustomOtlpConfiguration {
    ...
    public let compression: CustomCompressionType
    public let exportAsJson: Bool
    public init(
        timeout: TimeInterval  = CustomOtlpConfiguration.DefaultTimeoutInterval,
        compression: CustomCompressionType = .gzip,
