...
public struct IMQAFileSystem {
    static let rootDirectoryName = "io.imqa.data"
    ...
    public static let defaultPartitionId = "default"
    ...
    /// Returns a subpath within the root directory of the IMQA SDK.
    /// ```
    /// io.imqa.data/<version>/<partition-id>/<name>
    /// ```
    /// - Parameters:
    ...
    /// ```
    /// io.imqa.data/<version>/<partition-id>/storage
    /// ```
    ...
    /// ```
    /// io.imqa.data/<version>/<partition-id>/uploads
    /// ```
    ...
    /// ```
    /// io.imqa.data/<version>/<partition-id>/capture
    /// ```
